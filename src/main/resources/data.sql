...
INSERT INTO users (username, password, email, member_profile) VALUES('gbies','$2a$10$YwckUKeTAp1NvN4qozRSDOkXMoIKV3RHjwdox540CV9oh.DRNMZqi', 'g.bies@fryslan.nl', 'gbies');
INSERT INTO users (username, password, email, member_profile) VALUES('adjong87','$2a$10$kyVFisSyoq4y1aFiw1FIueBC3dNqDGltTDyNXWOe3bjkx.A72CA4W', 'adjong87@gmail.com', 'adjong87');
INSERT INTO users (username, password, email, member_profile) VALUES('kslabikova','$2a$10$hUR7JaHbteZlAKiZF7mNi.sjdvtCcYZOVJUvBv1lKykgpkUVc773i', 'kristina.gaudi@gmail.com', 'kslabikova');
INSERT INTO users (username, password, email, member_profile) VALUES('jeanneau','$2a$10$hUR7JaHbteZlAKiZF7mNi.sjdvtCcYZOVJUvBv1lKykgpkUVc773i', 'jeanneau@gmail.com', 'jeanneau');
INSERT INTO users (username, password, email, member_profile) VALUES('hermans','$2a$10$hUR7JaHbteZlAKiZF7mNi.sjdvtCcYZOVJUvBv1lKykgpkUVc773i', 'hermanengreetschaapherder@gmail.com', 'hermans');
INSERT INTO users (username, password, email, member_profile) VALUES('john','$2a$10$hUR7JaHbteZlAKiZF7mNi.sjdvtCcYZOVJUvBv1lKykgpkUVc773i', 'johndeman@gmail.com', 'john');
INSERT INTO users (username, password, email, member_profile) VALUES('hermand','$2a$10$hUR7JaHbteZlAKiZF7mNi.sjdvtCcYZOVJUvBv1lKykgpkUVc773i', 'hermandriessen@gmail.com', 'hermand');
INSERT INTO users (username, password, email, member_profile) VALUES('jan','$2a$10$hUR7JaHbteZlAKiZF7mNi.sjdvtCcYZOVJUvBv1lKykgpkUVc773i', 'jandekale@gmail.com', 'jan');
...
-- INSERT INTO score_card(id, aim_scorep1, aim_scorep2, filled_in, gespeeld_Op, nr_of_turns, player_one_name, player_one_score, player_two_name, player_two_score) VALUES (33, 27, 38, false, '2022-07-01', 24, 'Arjen', ARRAY [0,1,2,1,0,0,0,2,1,0,0,5,1,1,2,0,0,2,2,0,0,3,2,2], 'Herman', ARRAY[0,1,1,1,0,7,0,2,1,0,0,1,1,1,2,0,0,2,2,0,0,3,2,2]);
