...
public class ScoreCardController {
    ...
    @PutMapping("/fill")
    public ResponseEntity<ScoreCardDto> fillInScore(@RequestParam(value = "id") Long id,
                                                    @RequestBody ScoreCardInputDto scoreCardInputDto) {
        return ResponseEntity.ok(scoreCardService.fillInScore(id, scoreCardInputDto));
    }
}
